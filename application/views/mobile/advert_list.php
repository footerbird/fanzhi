        ...
        <div class="swiper-container advert-swiper" id="advert_container">
            ...
            <div class="swiper-wrapper">
                ...
                <section class="swiper-slide swiper-slide-v">
                    ...
                    <?php }else{ ?>
                    <video class="banner" src="<?php echo $advert->ad_address; ?>" poster="<?php echo $advert->video_poster; ?>" type="video/mp4" loop="loop" preload="load" webkit-playsinline="true" playsinline="true" x-webkit-airplay="true" x5-video-player-type="h5" x5-video-player-fullscreen="portraint">当前浏览器不支持</video>
                    <?php } ?>
